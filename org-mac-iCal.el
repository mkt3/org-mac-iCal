...
(defcustom org-mac-iCal-file diary-file
  "Name of the file to which iCal dates are saved.

This file will be destructively overwritten by `org-mac-iCal`.

If the file has the .org extension, it will be written as an Org
file, otherwise it will be a diary file.
"
  :group 'org-time
  :type 'file)
...
the the Emacs diary"
  ...
  (with-temp-buffer
    (insert-file-contents org-mac-iCal-file)
    (delete-region (point-min) (point-max))
    (when (string-match-p "\.org$" org-mac-iCal-file)
      (insert "# DO NOT EDIT -- This file is generated by `org-mac-iCal`\n\n* Diary\n"))
    (write-region (point-min) (point-max) org-mac-iCal-file))
